...
export default function QuickForecast() {
  ...
  if (!dict?.Features?.QuickForecast) return null;

  const content = dict.Features.QuickForecast;
  ...
  return (
    <Box component="section" sx={{ py: 8 }}>
          ...
          <Grid size={{ xs: 12, md: 6 }}>
            ...
            >
              <Box sx={{ position: "relative", height: 500, borderRadius: 1, overflow: "hidden" }}>
                <Image
                  src="/images/images_features/quickForecast.png"
                  alt="График с прогнозом"
                  fill
      ...
      <ImageModal
        ...
        imageSrc="/images/images_features/quickForecast.png"
        imageAlt="График с прогнозом"
      />
    </Box>
  );
}

...
import NewMemberSkeleton from "@/app/_components/NewMemberSkeleton";
            ...
            <Card sx={{ height: "100%", minHeight: `620px` }}>
              ...
              >
                ...
                {member?.job_title && (
                  <Stack sx={{ minHeight: `23px` }}>
                    <MemberField>
                      ...
                      <Typography
                        sx={{ whiteSpace: "collapse", userSelect: "none" }}
                        variant="caption"
                        component="div"
                      >
                        {member.job_title}
                ...
                <Stack sx={{ minHeight: isSm ? `90px` : `60px` }}>
                  {member?.education && (
                    <MemberField tooltip={false} size="large">
                ...
                <Grid container spacing={0.5} justifyContent={"center"}>
                  {member?.contacts?.telegram && (
                    <MemberField tooltip={true} product={"telegram"}>
                  ...
                  {member?.contacts?.github && (
                    <MemberField tooltip={true} product={"github"}>
                      <GithubIcon />
                      <Typography
                        sx={{ textOverflow: "ellipsis", userSelect: "none" }}
                        variant="caption"
                  ...
                  {member?.contacts?.email && (
                    <MemberField tooltip={true} product={"email"}>
                      <AlternateEmailIcon />
                      <Typography
                        sx={{ textOverflow: "ellipsis", userSelect: "none" }}
                        variant="caption"
                  ...
                  {member?.contacts?.orcid && (
                    <MemberField tooltip={true} product={"orcid"}>
                      <Box
                        sx={{
                          alignItems: "center",
                          display: "flex",
